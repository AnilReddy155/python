...
def search_hotel():
  try:
    ...
    guests = e5.get()
    # location = 'chennai'
    # check_in_date = '20210925'
    # check_out_date = '20210926'
    # no_of_rooms = '1'
    # guests = '2'
    ...
    if droupdown:
          ...
          if priceLowtoHigh:
              ...
              #     randomClick[0].click()
              #     time.sleep(5)
    # hotel_names = driver.find_elements_by_xpath("//h4[contains(@class, 'dwebCommonstyles__SmallSectionHeader-sc')]")
    # print(hotel_names[0])
    ...
    hotel_ratings = soup.find_all('span', attrs={'class':re.compile('ReviewAndRatingsstyles__AverageReviewText-sc')})
    nearest_locations = soup.find_all('div' , attrs={'class': re.compile('PersuasionHoverTextstyles__TextWrapperSpan-sc-1c06rw1-14 cTsPPE')}) 
    ...
    print(hotel_info)
    file_name = "Hotel_data/hotel_info-"+str(random.randint(0,100))+".xlsx"
